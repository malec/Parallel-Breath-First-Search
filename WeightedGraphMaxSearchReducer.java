...
// /**
//  * A reducer class that just emits the sum of the input values and the path that
//  * got us to that node.
//  * 
//  * Note that the reducer executes for each key (each Node ID)
//  * 
//  * Input key is the node ID Input values have the following format:
//  * WEIGHT|EDGES|DISTANCE|COLOR|path_taken_edges|
//  */
// @SuppressWarnings("deprecation")
// public class WeightedGraphMaxSearchReducer extends MapReduceBase
...
//         // indicates the color of the maximum distance node that got us to the Node ID
//         // (key). Initially set to White
...
//             else if ((maxDistanceWeightedNodeColor == WeightedNode.Color.WHITE)
